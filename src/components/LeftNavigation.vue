...
// In this app we navigate only among project-scoped routes.
// Keep a local union of the route names we use here to get nice TS help.
type ProjectRouteName = 'Board' | 'Measurements' | 'Reservations' | 'PeopleWork' | 'Summary'

const route = useRoute()
const router = useRouter()

// Type guard to safely read :projectId from route.params without using `any`
...
// Keyboard shortcut: Ctrl/Cmd + B toggles the side navigation
